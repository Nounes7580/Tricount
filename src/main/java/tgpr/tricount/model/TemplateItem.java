...
public class TemplateItem extends Model {
    ...
    public static List<TemplateItem> getById(int templateId) {
        List<TemplateItem> allTemplateItems = getAll();
        List<TemplateItem> filteredItems = new ArrayList<>();
        for (TemplateItem item : allTemplateItems) {
