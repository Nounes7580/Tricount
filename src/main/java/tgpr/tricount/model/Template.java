...
public class Template extends Model {
    ...
    public static List<Template>  getByTricount(int tricountId) {
        return queryList(Template.class, "select * from templates where tricount=:tricountId",
                new Params("tricountId", tricountId));
    }
