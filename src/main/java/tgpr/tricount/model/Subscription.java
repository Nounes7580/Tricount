...
public class Subscription extends Model {
   ...
   // public static int getAll() {
    ...
    public static List<Subscription>  getAllByTricount(int tricountId) {
        return queryList(Subscription.class, "select * from subscriptions where tricount=:tricount",
                new Params("tricount", tricountId));
    }
}
